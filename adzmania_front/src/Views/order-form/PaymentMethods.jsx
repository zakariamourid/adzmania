...
function PaymentMethods({ defaultPaymentMethods, handlePaymentItemClick }) {
  return (
    <div className="mt-4 mb-6 flex justify-center payment-methods">
        ...
        <ul className="my-4 space-y-3">
          {defaultPaymentMethods.map((item, index) => (
            <li
              key={index}
              href="#"
              className={` cursor-pointer flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow ${
